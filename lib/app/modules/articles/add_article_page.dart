...
class AddArticlePage extends StatefulWidget {
  ...
  const AddArticlePage({Key? key, this.onArticleAdded}) : super(key: key);
  @override
  AddArticlePageState createState() => AddArticlePageState();
}
          ...
          children: [
            Row(
              children: [
                HighlightContainer(
                    child: Text(
                  AppLocalizations.of(context)?.articles_write ?? '',
